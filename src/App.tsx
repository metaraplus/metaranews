    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 antialiased font-sans flex flex-col justify-between" id="applet-viewport">
      ...
      <section className="bg-slate-50 flex-1 py-8" id="dashboard-content-tabs-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          {/* --- TAB CONTENT 7: AGENDA BUKU NOMOR SURAT --- */}
          {activeTab === 'agenda' && (
            <div className="space-y-6 animate-in fade-in duration-200" id="agenda-tab-view">
              <div>
                <h3 className="font-bold text-slate-900 text-md flex items-center gap-2 no-print-element">
                  <BookOpen className="w-5 h-5 text-sky-600" />
                  Agenda Buku Nomor Surat (Letter Registry)
                </h3>
                <p className="text-xs text-slate-500 mt-0.5 no-print-element">
                  Daftar rekapitulasi otomatis seluruh nomor surat penawaran dan SPJ/invoice yang telah dibuat, lengkap dengan status nominal anggaran dan pejabat penandatangan.
                </p>
              </div>
